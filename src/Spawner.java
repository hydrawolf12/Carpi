public class Spawner
{
	...
	public static int returnRate()public class Spawner
{
	private static int currentSpeed;
	private static int currentHealth;
	private static int rate;
	...
	public static int returnRate() //IN MILLISECONDS, NOT SECONDS.  SO MULTIPLE WHATEVER IT CURRENT IT IS BY 1000.
	{
		return rate;
	}
 ...
 //IN MILLISECONDS, NOT SECONDS.  SO MULTIPLE WHATEVER IT CURRENT IT IS BY 1000.
	{
		return rate;
	}
	public Boss spawnBoss()
